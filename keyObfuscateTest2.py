...
dec_aes_key = asdf.key_decrypt(enc_aes_key)
print(f"alg1_dec: {dec_aes_key:016X}")
enc_aes_key2 = asdf.key2_encrypt(dec_aes_key)
print(f"alg4_enc: {enc_aes_key2:016X}")
dec_aes_key2 = asdf.key2_decrypt(enc_aes_key2)
print(f"alg4_dec: {dec_aes_key2:016X}")
